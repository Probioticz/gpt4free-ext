...
// By LOLEMO, Forked by Anonymous_cat1 and then forked by MubiLop Then Modfified by Otto (Me)
// Only tested on Penguinmod.com
// IDs are not changed from PenguinGPT to PenguinAI for compability, But Changed from PenguinAI to GPT4Free.

(function(Scratch) {
    'use strict';
    console.log("Loaded GPT4Free v2.0 by Otto (https://github.com/Probioticz/)")
    ...
    if (!Scratch.extensions.unsandboxed) {
        throw new Error('"GPT4Free" cannot run unsandboxed.');
    }
    ...
    let api_url = 'https://g4f.dev/v1/';

    Scratch.fetch('https://g4f.dev/v1/models')
        .then(response => {
            if (!response.ok) {
    ...
    const vm = Scratch.vm;    class GPT4Free {
        constructor() {
            this.chatHistories = {};
    ...
    Scratch.extensions.register(new GPT4Free));
})(Scratch);
